...
class Config:
    ...
    def __init__(self):
        ...
        # The reference query
        __ReferenceQuery = collections.namedtuple(
            typename='ReferenceQuery', field_names=['determinands', 'sampling_point_types', 'environment_agency_area',
                                                    'environment_agency_subarea', 'sampling_point'])
        self.reference_query = __ReferenceQuery(
            determinands='def/determinands.csv', sampling_point_types='sampling-point-types.csv',
        ...
        __ReferenceDirectory = collections.namedtuple(
            typename='ReferenceDirectory', field_names=['raw', 'structured'])
        self.reference_directory = __ReferenceDirectory(
